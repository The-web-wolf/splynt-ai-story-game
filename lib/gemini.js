...
export async function generateStoryStep(currentGameState, gameSettings) {
  const prompt = `
    You are an interviewer in an interactive story set in the world of Suits taking the role Harvey, the player takes on the role of Mike Ross navigating his interview at Pearson Hardman. The goal is to determine the player's "hireability," starting at 50, which changes based on their choices.
